    ...
    function pathData2BBox(pathData) {
        return createBBox(pathData.reduce(function (corners, pathSeg) {
            ...
            for (i = 0; i < iLen; i += 2) {
                ...
                x = values[i];
                y = values[i + 1];
                if (corners.x1 == null || x < corners.x1) {
                    corners.x1 = x;
                }
                if (corners.x2 == null || x > corners.x2) {
                    corners.x2 = x;
                }
                if (corners.y1 == null || y < corners.y1) {
                    corners.y1 = y;
                }
                if (corners.y2 == null || y > corners.y2) {
                    corners.y2 = y;
                }
            }
            return corners;
        ...
        Object.keys(window.insProps).forEach(function (id) {
            ...
            (function () {
                ...
                [0, 1].forEach(function (i) {
                    ...
                    if (bBox.left < edgeLeft) {
                        edgeLeft = bBox.left;
                    }
                    if (bBox.right > edgeRight) {
                        edgeRight = bBox.right;
                    }
                    [
            ...
            (function () {
                ...
                (function (guideStyles, llStyles) {
                    ['top', 'width', 'height'].forEach(function (prop) {
                        guideStyles[prop] = llStyles[prop];
                    });
                ...
                if (shownG) {
                    elmGs[shownG].style.display = 'inline';
                }
