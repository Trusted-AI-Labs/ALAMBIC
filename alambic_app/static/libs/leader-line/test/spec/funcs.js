...
describe('funcs', function () {
    ...
    describe('_isObject()', function () {
        it('5', function () {
            expect(_isObject(5)).toBe('0:true,1:false,5:false');
        });
        it('\'a\'', function () {
            expect(_isObject('a')).toBe('0:true,1:false,5:false');
        });
        it('true', function () {
            expect(_isObject(true)).toBe('0:true,1:false,5:false');
        });
        it('false', function () {
            expect(_isObject(false)).toBe('0:false');
        });
        it('undefined', function () {
            expect(_isObject()).toBe('0:false');
        });

        it('{}', function () {
            expect(_isObject({})).toBe('0:true,1:true,2:false,3:true,4:true');
        });
        it('Object.create(null)', function () {
            expect(_isObject(Object.create(null))).toBe('0:true,1:true,2:true');
        });
        // eslint-disable-next-line no-new-object
        it('new Object()', function () {
            expect(_isObject(new Object())).toBe('0:true,1:true,2:false,3:true,4:true');
        });

        it('[]', function () {
            expect(_isObject([])).toBe('0:true,1:false,5:true');
        });
        it('document.body', function () {
            expect(_isObject(document.body)).toBe('0:true,1:false,5:false');
        });
    });
    ...
    describe('copyTree()', function () {
        ...
        it('5', function () {
            expect(copyTree(5)).toBe(5);
        });
        it('\'a\'', function () {
            expect(copyTree('a')).toBe('a');
        });
        it('true', function () {
            expect(copyTree(true)).toBe(true);
        });
        it('false', function () {
            expect(copyTree(false)).toBe(false);
        });
        it('undefined', function () {
            expect(copyTree(undefined)).toBe(undefined);
        });

        it('copied object', function () {
    ...
    describe('hasChanged()', function () {
        ...
        it('5, \'5\'', function () {
            expect(hasChanged(5, '5')).toBe(true);
        });
        ...
        it('true, \'true\'', function () {
            expect(hasChanged(true, 'true')).toBe(true);
        });
        ...
        it('false, \'false\'', function () {
            expect(hasChanged(false, 'false')).toBe(true);
        });
        ...
        it('false, undefined', function () {
            expect(hasChanged(false, undefined)).toBe(true);
        });
        it('{}, []', function () {
            expect(hasChanged({}, [])).toBe(true);
        });
        it('{}, 5', function () {
            expect(hasChanged({}, 5)).toBe(true);
        });
