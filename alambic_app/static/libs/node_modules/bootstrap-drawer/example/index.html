...
<div id="drawerExample" class="drawer dw-xs-10 dw-sm-6 dw-md-4 fold" aria-labelledby="drawerExample">
    <div class="drawer-controls">
        <a href="#drawerExample" data-toggle="drawer" href="#drawerExample" aria-foldedopen="false"
           aria-controls="drawerExample" class="btn btn-primary btn-sm">Menu</a>
    </div>
...
<div id="drawer-page" class="container">
    <div class="jumbotron">
        ...
        <p>The more common name for a drawer menu, I learned, is "off-canvas"; but, that name was taken for other
            packages that also did this. Even so, the current bootstrap package (3.2.2) doesn't have any off-canvas
            elements by default even though it is becoming a growing mobile design trend. Granted, this might change in
            the future, but - hey - I made this for now.</p>
        <p>This page contains a basic example of how to use the full page. See the <a
                href="http://clineamb.github.io/bootstrap-drawer" target="_blank">documentation page</a> for more
            details and more examples!</p>
        <p>If you have any issues or questions, please <a href="https://github.com/clineamb/bootstrap-drawer/issues"
                                                          target="_blank">check out out the repo and drop an issue</a>.
