...
<p>Bootstrap drawer comes with <code>drawer.js</code> to be added to the <code>bootstrap.js</code> component suite. If
    you&#39;re including separate components, <code>drawer.js</code> depends on <code>transition.js</code> plugin.</p>
...
<div class="panel panel-default has-inner-drawer example-container-right">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-xs-6">
                <p>
                    <a href="#drawerExample2" data-toggle="drawer" aria-expanded="false" aria-controls="drawerExample2"
                       class="btn btn-primary">Link with href</a>
                </p>
                <p>
                    <button class="btn btn-info" type="button" data-toggle="drawer" data-target="#drawerExample2"
                            aria-expanded="false" aria-controls="drawerExample2">
...
<p>These classes can be found in <code>less/mixins/drawer-framework.less</code>. They are built in loops with the <code>.dw-SIZE-#</code>
    classes because they utilize margins based on the column width.</p>
<h4 id="via-data-attributes">Via data attributes</h4>
<p>Just add <code>data-toggle=&quot;drawer&quot;</code> and a data-target to the element to automatically assign control
    of drawer element. The data-target attribute accepts a CSS selector to apply the folding animation to. Be sure to
    add the class <code>.fold</code> to the collapsible element. If you&#39;d like it to default open, add the
    additional class <code>.open</code>.</p>
...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>selector</td>
        <td>false</td>
        <td>If a selector is provided, then all collapsible elements under the specified parent will be closed when this
            drawer is open.
        </td>
    </tr>
    <tr>
...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>This event is fired when a collapse element has been made visible to the user (will wait for CSS transitions
            to complete).
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>This event is fired when a collapse element has been hidden from the user (will wait for CSS transitions to
            complete).
        </td>
    </tr>
</table>
