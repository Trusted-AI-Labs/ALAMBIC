...
<p><strong>bootstrap-drawer</strong> comes with some built-in classes to customize some basics about your drawer. These
    utility classes are modeled after Bootstrap&#39;s Navbar components.</p>
<hr>
<h2 id="position">Position</h2>
<p>Sometimes you might want the drawer to the right. You can do this quickly by adding <code>.drawer-right</code> to the
    <code>.drawer</code> container.</p>
...
<div class="panel panel-default has-inner-drawer example-container-right">
    ...
    <div class="panel-body">
        <p>You can position the drawer to the right by adding the <code>.drawer-right</code> class. This also works on
            full-page drawers.</p>
    </div>
</div>
...
<p>Like the Bootstrap navbar, there is an inverse color option to the drawer. Just add <code>.drawer-inverse</code> to
    your <code>.drawer</code> container.</p>
